...
onready var idle_time = enemy.get_node("Timers/IdleTime")
onready var patrol_time = enemy.get_node("Timers/PatrolTime")
onready var attack_time = enemy.get_node("Timers/AttackTime")
